...
// static mut DEBUG_WRITER: Option<&'a mut DebugWriterWrapper> = None;

// pub static mut OUTPUT_BUF: [u8; 64] = [0; 64];
// pub static mut INTERNAL_BUF: [u8; 1024] = [0; 1024];

// pub unsafe fn get_debug_writer() -> &'a mut DebugWriterWrapper {
...
//     pub fn new(dw: &'a DebugWriter) -> DebugWriterWrapper {
//         DebugWriterWrapper {
//             dw: MapCell::new(dw),
//         }
//     }
...
//     fn transmitted_buffer(&self, buffer: &'a mut [u8], tx_len: usize, _rcode: ReturnCode) {
